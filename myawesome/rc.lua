...
beautiful.init("~/.config/awesome/themes/macos-dark/theme.lua")
...
local function apply_roundrect(c)
...
awful.screen.connect_for_each_screen(function(s)
  ...
  s.mywibox = awful.wibar({
    position = "top",
    screen   = s,
    -- width = screen_width - beautiful.useless_gap * 2
...
client.connect_signal("manage", function(c)
  ...
  apply_roundrect(c)
  if c.class == "Opera" then c.properties.border_width = dpi(0) end
end)
...
client.connect_signal("request::titlebars", function(c)
  ...
  if titlebars_enabled and (c.type == "normal" or c.type == "dialog") then
    ...
    awful.titlebar(c, { size = 28 }):set_widget(layout)
  end
